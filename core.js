...
async function getSupabase(){if(C.DEMO_MODE)return null;if(!window.supabase)throw new Error('Supabase client not loaded');return window.supabase.createClient(C.SUPABASE_URL,C.SUPABASE_PUBLISHABLE_KEY)}
